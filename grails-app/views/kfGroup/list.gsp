...
<html>
	...
	<body>
		<a href="#list-kfGroup" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-kfGroup" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${kfGroupInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
